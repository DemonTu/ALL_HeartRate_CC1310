...
#define Speed                    0x34 // Speed (1/1000＊s of miles per hour)
...
#define RRI_Data_Register1       0x37 // Bit0 每 Bit9 = 1st peak timestamp in ms (0-999)
									  // Bit15: 1 = Leading interval, 0 = Relative interval
#define RRI_Data_Register2       0x38 // Bit0 每 Bit9 = 2nd peak timestamp in ms (0-999)	
									  //Bit15: 1 = Leading interval, 0 = Relative interval
#define RRI_Data_Register3		 0x39 // Bit0 每 Bit9 = 3rd peak timestamp in ms (0-999)
									  //Bit15: 1 = Leading interval, 0 = Relative interval
#define RRI_Data_Register4 		 0x3A // Bit0 每 Bit9 = 4th peak timestamp in ms (0-999)
									  //Bit15: 1 = Leading interval, 0 = Relative interval
#define RRI_Data_Register5       0x3B //Bit0 每 Bit9 = 5th peak timestamp in ms (0-999)
                                      //Bit15: 1 = Leading interval, 0 = Relative interval
