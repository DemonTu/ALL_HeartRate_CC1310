...
.dlls,rm3 .dlls: heartBeat.prm3

-include package/cfg/heartBeat_prm3.mak
-include package/cfg/heartBeat_prm3.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/heartBeat_prm3.dep
endif
heartBeat.prm3: package/cfg/heartBeat_prm3.xdl
	@


ifeq (,$(wildcard .libraries,rm3))
heartBeat.prm3 package/cfg/heartBeat_prm3.c: .libraries,rm3
endif

package/cfg/heartBeat_prm3.c package/cfg/heartBeat_prm3.h package/cfg/heartBeat_prm3.xdl: override _PROG_NAME := heartBeat.xrm3
package/cfg/heartBeat_prm3.c: package/cfg/heartBeat_prm3.cfg
package/cfg/heartBeat_prm3.xdc.inc: package/cfg/heartBeat_prm3.xdl
package/cfg/heartBeat_prm3.xdl package/cfg/heartBeat_prm3.c: .interfaces

clean:: clean,rm3
	-$(RM) package/cfg/heartBeat_prm3.cfg
	-$(RM) package/cfg/heartBeat_prm3.dep
	-$(RM) package/cfg/heartBeat_prm3.c
	-$(RM) package/cfg/heartBeat_prm3.xdc.inc

clean,rm3::
	-$(RM) heartBeat.prm3
.executables,rm3 .executables: heartBeat.xrm3

heartBeat.xrm3: |heartBeat.prm3

-include package/cfg/heartBeat.xrm3.mak
heartBeat.xrm3: package/cfg/heartBeat_prm3.orm3 
	$(RM) $@
	@$(MSG) lnkrm3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	LC_ALL=C $(iar.targets.arm.M3.rootDir)/bin/ilinkarm -o C:/work/source/ALL_HeartRate_CC1310/software/IAR/worksplace/HeartRate/Debug/Exe/heartBeat.out --config C:/work/source/ALL_HeartRate_CC1310/software/IAR/worksplace/HeartRate/heartBeat_CC1310_LAUNCHXL.icf -f C:/work/source/ALL_HeartRate_CC1310/software/IAR/worksplace/HeartRate/configPkg/linker.cmd c:/ti/tirtos_cc13xx_cc26xx_2_16_01_14/products/cc13xxware_2_03_02_16941/driverlib/bin/iar/driverlib.lib --silent --cpu=Cortex-M3 --entry=__iar_program_start --redirect _Printf=_PrintfSmall --redirect _Scanf=_ScanfSmall --semihosting --entry __iar_program_start --vfe --silent -o $@ package/cfg/heartBeat_prm3.orm3 -f package/cfg/heartBeat_prm3.xdl  --semihosting=iar_breakpoint  --cpu=Cortex-M3 --map $(XDCCFGDIR)/$@.map  --redirect _Printf=_PrintfSmall --redirect _Scanf=_ScanfSmall 
	

heartBeat.test test,rm3 test: heartBeat.xrm3.test

heartBeat.xrm3.test:: heartBeat.xrm3
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 heartBeat.xrm3.test
else
	@$(MSG) running $<  ...
	$(call EXEC.heartBeat.xrm3, ) 
endif

clean,rm3::
	-$(RM) $(wildcard .tmp,heartBeat.xrm3,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
heartBeat_prm3.orm3,copy : package/cfg/heartBeat_prm3.orm3
heartBeat_prm3.srm3,copy : package/cfg/heartBeat_prm3.srm3
